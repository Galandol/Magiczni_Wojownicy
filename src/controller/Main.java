...
//		int randomNum = ThreadLocalRandom.current().nextInt(human.getWeapon().getMinDamage(), human.getWeapon().getMaxDamage() + 1);
//
...
//		//Random ran = new Random();
//		int randomNum = ThreadLocalRandom.current().nextInt(orc.getWeapon().getMinDamage(), orc.getWeapon().getMaxDamage() + 1);
//		// System.out.println(randomNum);
//		return randomNum;
//	}
//
